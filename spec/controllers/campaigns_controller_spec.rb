...
RSpec.describe CampaignsController, type: :controller do
  ...
  describe "#new" do #testing the controller
    it 'renders the new template' do
      #get request for a new action in the campaign controller
      get :new
      #response is a method from RSpec Rails that we can use to match the output or the result of making a specific request
      #render_template is a RSpec
