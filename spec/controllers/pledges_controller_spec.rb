  ...
  describe "#create" do
    ...
    context "with signed in user" do
      ...
      context "valid attributes" do
        ...
        it 'associate the created pledge with the logged in user' do
          valid_request
          expect(Pledge.last.user).to eq(user)
        end

        it 'associate the created pledge with the campaign' do
          valid_request
      ...
      context "invalid attributes" do
        ...
        it "doesn't create the pledge in the database" do
          count_before = Pledge.count
          invalid_request
          count_after = Pledge.count
  ...
  describe "#destroy" do
    ...
    context "with signed in user" do
      ...
      it 'removes the pledge record from the database' do
        pledge #calls method defined by the let
        count_before = Pledge.count
        delete :destroy, params: {id: pledge.id, campaign_id: pledge.campaign.id}
        count_after = Pledge.count
        expect(count_after).to eq(count_before-1)
